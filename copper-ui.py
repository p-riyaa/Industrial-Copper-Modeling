...
try:
    st.set_page_config(page_title="Industrial Copper Modeling Application", page_icon=':trophy:',
                       layout='wide')
    #Background
    st.markdown(
        """<style>.main {background-color: #EEBFEF;}</style>""",unsafe_allow_html=True
    )
    selected = option_menu(
    menu_title="Industrial Copper Modeling Application",
    options = ["Home","Predict Selling Price","Predict Status"],
    icons = ["house","database-add","building-add"],
    # default_index = 0,
    ...
    if selected == "Predict Selling Price":
        ...
        if submit_button and flag == 0:
            ...
            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/scaler.pkl", 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/s.pkl", 'rb') as f:
    ...
    if(selected=="Predict Status"):
        ...
        if csubmit_button and cflag == 0:
            ...
            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:/Users/Pooja/PycharmProjects/CopperInustryApp/.venv/source/ct.pkl", 'rb') as f:
